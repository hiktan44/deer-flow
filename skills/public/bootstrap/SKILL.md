---
name: bootstrap
description: Sıcak ve uyarlanabilir bir tanışma sohbeti aracılığıyla kişiselleştirilmiş bir SOUL.md oluştur. Kullanıcı AI partnerinin kimliğini oluşturmak, kurmak veya başlatmak istediğinde tetiklenir — örneğin "SOUL.md oluştur", "ajanımı başlat", "AI partnerimi kur", "kim olduğunu tanımla", "tanışma yapalım", "bu AI'ı kişiselleştir" veya SOUL.md eksik olduğunda. Güncellemeler için de tetiklenir: "SOUL.md'yi güncelle", "AI kişiliğimi değiştir".
---
