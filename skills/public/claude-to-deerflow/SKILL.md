...
description: "DeerFlow AI ajan platformuyla HTTP API üzerinden etkileşim kur. Kullanıcı DeerFlow'a araştırma/analiz için mesaj veya soru göndermek, DeerFlow sohbet başlatmak, DeerFlow durumunu kontrol etmek, mevcut modelleri/yetenekleri/ajanları listelemek, DeerFlow belleğini yönetmek, dosya yüklemek veya karmaşık araştırma görevlerini DeerFlow'a devretmek istediğinde kullanılır."
---
